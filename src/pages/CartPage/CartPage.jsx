                        ...
                        <div key={item.id} className={styles.cartItem}>
                            ...
                            <div className={styles.itemControls}>
                                ...
                                <div className={styles.priceSection}>
                                    <span className={styles.currentPrice}>${item.price * item.quantity}</span>
                                    {item.originalPrice && (
...
//             <div className={styles.itemHeader}>
//                 <h3 className={styles.itemTitle}>Secateurs</h3>
//             </div>
//             <div className={styles.itemControls}>
//                 <div className={styles.quantitySection}>
...
//         <div className={styles.cartItem}>
//             <div className={styles.itemHeader}>
//                 <h3 className={styles.itemTitle}>Collection for berries (plastic)</h3>
//             </div>
//             <div className={styles.itemControls}>
//                 <div className={styles.quantitySection}>
//                     <button className={styles.quantityBtn}>-</button>
...
//         <div className={styles.cartItem}>
//             <div className={styles.itemHeader}>
//                 <h3 className={styles.itemTitle}>Bayonet shovel</h3>
//             </div>
//             <div className={styles.itemControls}>
//                 <div className={styles.quantitySection}>
//                     <button className={styles.quantityBtn}>-</button>
...
//                 </div>
//                 <div className={styles.priceSection}>
//                     <span className={styles.currentPrice}>$360</span>
//                 </div>
//             </div>
//         </div>
//         <div className={styles.divider}></div>
...
//             <div className={styles.orderTotal}>
//                 <span>Total</span>
//                 <span className={styles.totalPrice}>$541,00</span>
//             </div>
//         </div>
